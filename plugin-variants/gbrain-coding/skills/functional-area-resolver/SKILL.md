...
Brain-first analyzer note: this skill names other skills such as
`perplexity-research` in dispatcher prose, but it rewrites local routing
tables and does not call external APIs.
